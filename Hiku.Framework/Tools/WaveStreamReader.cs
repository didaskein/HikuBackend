...
namespace Hiku.Framework.Tools
{
    /// <summary>
    /// WaveStreamReader simplifies opening an audio file in NAudio
    /// Simply pass in the WaveStream
    ...
    /// </summary>
    public class WaveStreamReader : WaveStream, ISampleProvider
    {
        ...
        public WaveStreamReader(WaveStream convertedStream)
        {
