...
{
    public static class WaveStreamReaderExt
    {
        ...
        public static TimeSpan GetSilenceDuration(this WaveStreamReader reader,
                                                  SilenceLocation location = SilenceLocation.Start,
