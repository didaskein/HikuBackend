...
namespace Hiku.Framework
{
    public class AudioHelper
    {
        ...
        //https://github.com/Azure-Samples/cognitive-services-speech-sdk/blob/master/samples/csharp/sharedcontent/console/speech_recognition_samples.cs#L309
        ...
        public static AudioConfig OpenWavFile(Stream reader)
        {
            AudioStreamFormat format = readWaveHeader(new System.IO.BinaryReader(reader));
    ...
    /// </summary>
    public sealed class WaveStreamStreamReader : PullAudioInputStreamCallback
    {
        ...
        public WaveStreamStreamReader(WaveStream reader)
        {
            _reader = reader;
        }
